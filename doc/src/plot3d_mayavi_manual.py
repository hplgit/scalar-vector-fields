...
# Draw countours of 3D scalar field togeth with 3D vector field
...
plt.quiver3d(xv, yv, zv, u, v, w, mode='arrow', colormap='jet', scale_mode='none', opacity=0.5)
# end draw countours of 3D scalar field togeth with 3D vector field
